...
<div class="card">
  <div class="card-header card-header-primary">
    <h2 class="text-center prestyle"><?= isset($titulo) ?  $titulo : "OPERACIONES DE CRÉDITO" ?><small></small></h2>


    <?php if (!isset($titulo)) :  ?>
      <a href="<?= base_url("prestamo/create") ?>" class="btn btn-sm btn-primary">NUEVA OPERACIÓN</a>
    <?php endif; ?>
